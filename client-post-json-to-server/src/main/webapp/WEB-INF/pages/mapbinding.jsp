...
<body>
<a href="${pageContext.servletContext.contextPath}">JSON single object</a>|<a href="${pageContext.servletContext.contextPath}/multiple">JSON Multiple object use org.codehaus.jackson( treenodebinding)</a><br/>
